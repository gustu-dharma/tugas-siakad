	...
	while(1) {
		...
		switch (menu_terpilih) {
			case 1:{
                ...
                mahasiswa inputMhs = mahasiswa(id, nama, dd, mm, yy, nrp, departemen, tahunmasuk, fakultas);
                recMhs.push_back(inputMhs);
            }
				break;
			case 2: {
				idDosen++;
                string id, nama, npp, departemen,pendidikan, fakultas;
                int dd, mm, yy;
                id = idDosen;
                ...
                dosen inputDosen = dosen(id, nama, dd, mm, yy, npp, departemen, pendidikan, fakultas);
