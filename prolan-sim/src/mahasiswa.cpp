...
mahasiswa::mahasiswa(std::string id, std::string nama, int dd, int mm, int yy, 
				std::string nrp, std::string departemen,int tahunmasuk, std::string fakultas)
		: person(id, nama, dd, mm, yy), nrp(nrp), departemen(departemen), tahunmasuk(tahunmasuk), fakultas(fakultas)
{
	this->ipk = 0.0;
	this->semesterke = 1;
	this->skslulus = 0;
